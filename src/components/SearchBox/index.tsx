...
import { ActiveRoute, ActiveView } from '../../contexts/Store'
...
const activeNode: { id: string; title: string } | undefined = undefined

const activeRoute: ActiveRoute = ActiveRoute.Network

const activeView: ActiveView = ActiveView.Map
