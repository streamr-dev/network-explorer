...
export const WithResults = () => {
  ...
  return (
    <Wrapper>
      <Search>
        <Search.Input value={search} onChange={setSearch} onClear={() => setSearch('')} />
        <Search.Results results={results} highlight={search} />
      </Search>
    </Wrapper>
  )
}
...
export const SearchInput = () => {
  ...
  return <Search.Input value={search} onChange={setSearch} onClear={() => setSearch('')} />
}

export const SearchResults = () => <Search.Results results={results} />
  ...
  return (
    <Wrapper>
      ...
      >
        ...
        {!!selected && <Error>Error loading the graph</Error>}
      </Search>
    </Wrapper>
  )
}
