...
export type GetSponsorshipsQueryVariables = Exact<{
  first: Scalars['Int']['input'];
  skip: Scalars['Int']['input'];
}>;


export type GetSponsorshipsQuery = { __typename?: 'Query', sponsorships: Array<{ __typename?: 'Sponsorship', spotAPY: any, totalStakedWei: any }> };
...
export const GetSponsorshipsDocument = gql`
  ...
  sponsorships(first: $first, skip: $skip) {
    ...
    `;
export type GetSponsorshipsQueryResult = Apollo.QueryResult<GetSponsorshipsQuery, GetSponsorshipsQueryVariables>;